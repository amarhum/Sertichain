...
//       // Ambil nonce dulu dari backend
//       const nonceRes = await fetch(`http://localhost:4000/login/nonce/${address}`);
...
//       alert("Anda membatalkan Akses alamatdompet.");
//     } else {
//       console.error(err);
...
//               <p className="text-gray-500 text-sm mb-4">Hubungkan alamat dompet ethereum anda untuk login dan akses halaman upload</p>
//             </div>
//             <div className="flex justify-center items-center mb-[25px]">
//               <button onClick={handleConnectWallet} className="bg-[#ffa47384] px-[10px] py-[8px] md:px-[20px] lg:px-[20px] lg:py-[15px] font-bold  rounded-[40px] hover:bg-[#ffa473ad] transition text-white cursor-pointer hover:text-[#0E253A] text-[16px] md:text-[16px] lg:text-[24px]">
